$(document).ready(function () {
    ...
    // let avatar = $('form[name="form-upload"').find('input[name=avatar]');
    // $('form[name="form-upload"').find('input[name=avatar]').remove();
    // $('form[name="form-upload"').append(avatar);

    $('form[name="form-upload"').submit((event) => {
        let avatar = $(this).find('input[name=avatar]');
        $(this).find('input[name=avatar]').remove();
        $('form[name="form-upload"').append(avatar).css({'display': 'none'});
    });
});
